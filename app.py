...
lineaccesstoken = '2VB2VVxBEHUB1d1koLH8JdeAjqP/Nn2ER0kUGoQ2NZzg4j5t8crPJtVkIdNw2p0uZO9AdMhfNNZNr1NDTbHWpnL1DfTPMwktrvNlyRwqbYOem7xBJy+bBtEwP1kDcD5mhZEguYolgP9D9aoJDZPSsAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="ดีจ้า หวัดดีคาบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "กินไรดี":
            replyObj = TextSendMessage(text="กินข้าว")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "แมว":
            replyObj = TextSendMessage(text="น่ารัก")  
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ดูหนังกัน":
            replyObj = TextSendMessage(text="เย่")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
           ...
           url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/f7264f18-c06a-4969-9bd2-67909f8ef0b6"
